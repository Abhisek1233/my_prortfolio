  ...
  const projects = [
    {
      ...
      technologies: ['JavaScript', 'React', 'Node.js', 'Express.js', 'MongoDB', 'Rest API', 'Tailwind CSS', 'Web Socket', 'JWT', 'Dynamic PDF'],
    ...
    },
    {
      id: 3,
      title: 'Compiler App',
      description: 'A versatile online code runner and mini IDE supporting multiple programming languages. Write, compile, and execute snippets in a clean web workspace with I/O panels and saved sessions. Built with React and Tailwind, it showcases API integration, async JavaScript, rate-limited execution, and sandboxes. Includes templates, shortcuts, and more.',
      image: <img src={Compiler} alt="Compiler App" style={{ width: '100%', height: '10%' }} />,
      technologies: ['JavaScript', 'HTML', 'CSS', 'WebAssembly', 'React', 'Express.js', 'Node.js', 'Rest API', 'Web Socket'],
    ...
    
    {
      ...
      description: 'An intelligent, collaborative note-taking app designed for real-time synchronization and productivity. Built with Next.js, Firebase, and Google\'s Gemini AI. Features include AI-generated tags, secure note sharing, rich text editing, and robust offline support. Utilizes Firebase for real-time data synchronization and Google Cloud Functions for serverless operations.',
    ...
    },
    {
      id: 6,
      title: 'Weather App',
      description: 'A simple weather application that fetches data from OpenWeatherMap API. Users can search for weather information by city name. Built to practice API integration and async JavaScript. Features include current weather conditions, temperature, humidity, and wind speed. Responsive design with a clean, modern interface.',
